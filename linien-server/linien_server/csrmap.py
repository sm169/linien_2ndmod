...
csr = {
    ...
    'logic_sweep_step': (8, 0x01b, 30, True),
    'logic_sweep_min': (8, 0x01f, 14, True),
    'logic_sweep_max': (8, 0x021, 14, True),
    'logic_sweep_run': (8, 0x023, 1, True),
    'logic_sweep_pause': (8, 0x024, 1, True),
    'logic_limit_error_signal_min': (8, 0x025, 25, True),
    'logic_limit_error_signal_max': (8, 0x029, 25, True),
    'logic_limit_fast1_min': (8, 0x02d, 14, True),
    'logic_limit_fast1_max': (8, 0x02f, 14, True),
    'logic_limit_fast2_min': (8, 0x031, 14, True),
    'logic_limit_fast2_max': (8, 0x033, 14, True),
    'logic_pid_setpoint': (8, 0x035, 25, True),
    'logic_pid_kp': (8, 0x039, 14, True),
    'logic_pid_ki': (8, 0x03b, 14, True),
    'logic_pid_reset': (8, 0x03d, 1, True),
    'logic_pid_kd': (8, 0x03e, 14, True),
    'logic_autolock_robust_time_scale': (8, 0x040, 14, True),
    'logic_autolock_robust_N_instructions': (8, 0x042, 5, True),
    'logic_autolock_robust_final_wait_time': (8, 0x043, 14, True),
    'logic_autolock_robust_peak_height_0': (8, 0x045, 28, True),
    'logic_autolock_robust_peak_height_1': (8, 0x049, 28, True),
    'logic_autolock_robust_peak_height_2': (8, 0x04d, 28, True),
    'logic_autolock_robust_peak_height_3': (8, 0x051, 28, True),
    'logic_autolock_robust_peak_height_4': (8, 0x055, 28, True),
    'logic_autolock_robust_peak_height_5': (8, 0x059, 28, True),
    'logic_autolock_robust_peak_height_6': (8, 0x05d, 28, True),
    'logic_autolock_robust_peak_height_7': (8, 0x061, 28, True),
    'logic_autolock_robust_peak_height_8': (8, 0x065, 28, True),
    'logic_autolock_robust_peak_height_9': (8, 0x069, 28, True),
    'logic_autolock_robust_peak_height_10': (8, 0x06d, 28, True),
    'logic_autolock_robust_peak_height_11': (8, 0x071, 28, True),
    'logic_autolock_robust_peak_height_12': (8, 0x075, 28, True),
    'logic_autolock_robust_peak_height_13': (8, 0x079, 28, True),
    'logic_autolock_robust_peak_height_14': (8, 0x07d, 28, True),
    'logic_autolock_robust_peak_height_15': (8, 0x081, 28, True),
    'logic_autolock_robust_peak_height_16': (8, 0x085, 28, True),
    'logic_autolock_robust_peak_height_17': (8, 0x089, 28, True),
    'logic_autolock_robust_peak_height_18': (8, 0x08d, 28, True),
    'logic_autolock_robust_peak_height_19': (8, 0x091, 28, True),
    'logic_autolock_robust_peak_height_20': (8, 0x095, 28, True),
    'logic_autolock_robust_peak_height_21': (8, 0x099, 28, True),
    'logic_autolock_robust_peak_height_22': (8, 0x09d, 28, True),
    'logic_autolock_robust_peak_height_23': (8, 0x0a1, 28, True),
    'logic_autolock_robust_peak_height_24': (8, 0x0a5, 28, True),
    'logic_autolock_robust_peak_height_25': (8, 0x0a9, 28, True),
    'logic_autolock_robust_peak_height_26': (8, 0x0ad, 28, True),
    'logic_autolock_robust_peak_height_27': (8, 0x0b1, 28, True),
    'logic_autolock_robust_peak_height_28': (8, 0x0b5, 28, True),
    'logic_autolock_robust_peak_height_29': (8, 0x0b9, 28, True),
    'logic_autolock_robust_peak_height_30': (8, 0x0bd, 28, True),
    'logic_autolock_robust_peak_height_31': (8, 0x0c1, 28, True),
    'logic_autolock_robust_wait_for_0': (8, 0x0c5, 14, True),
    'logic_autolock_robust_wait_for_1': (8, 0x0c7, 14, True),
    'logic_autolock_robust_wait_for_2': (8, 0x0c9, 14, True),
    'logic_autolock_robust_wait_for_3': (8, 0x0cb, 14, True),
    'logic_autolock_robust_wait_for_4': (8, 0x0cd, 14, True),
    'logic_autolock_robust_wait_for_5': (8, 0x0cf, 14, True),
    'logic_autolock_robust_wait_for_6': (8, 0x0d1, 14, True),
    'logic_autolock_robust_wait_for_7': (8, 0x0d3, 14, True),
    'logic_autolock_robust_wait_for_8': (8, 0x0d5, 14, True),
    'logic_autolock_robust_wait_for_9': (8, 0x0d7, 14, True),
    'logic_autolock_robust_wait_for_10': (8, 0x0d9, 14, True),
    'logic_autolock_robust_wait_for_11': (8, 0x0db, 14, True),
    'logic_autolock_robust_wait_for_12': (8, 0x0dd, 14, True),
    'logic_autolock_robust_wait_for_13': (8, 0x0df, 14, True),
    'logic_autolock_robust_wait_for_14': (8, 0x0e1, 14, True),
    'logic_autolock_robust_wait_for_15': (8, 0x0e3, 14, True),
    'logic_autolock_robust_wait_for_16': (8, 0x0e5, 14, True),
    'logic_autolock_robust_wait_for_17': (8, 0x0e7, 14, True),
    'logic_autolock_robust_wait_for_18': (8, 0x0e9, 14, True),
    'logic_autolock_robust_wait_for_19': (8, 0x0eb, 14, True),
    'logic_autolock_robust_wait_for_20': (8, 0x0ed, 14, True),
    'logic_autolock_robust_wait_for_21': (8, 0x0ef, 14, True),
    'logic_autolock_robust_wait_for_22': (8, 0x0f1, 14, True),
    'logic_autolock_robust_wait_for_23': (8, 0x0f3, 14, True),
    'logic_autolock_robust_wait_for_24': (8, 0x0f5, 14, True),
    'logic_autolock_robust_wait_for_25': (8, 0x0f7, 14, True),
    'logic_autolock_robust_wait_for_26': (8, 0x0f9, 14, True),
    'logic_autolock_robust_wait_for_27': (8, 0x0fb, 14, True),
    'logic_autolock_robust_wait_for_28': (8, 0x0fd, 14, True),
    'logic_autolock_robust_wait_for_29': (8, 0x0ff, 14, True),
    'logic_autolock_robust_wait_for_30': (8, 0x101, 14, True),
    'logic_autolock_robust_wait_for_31': (8, 0x103, 14, True),
    'logic_autolock_fast_target_position': (8, 0x105, 14, True),
    'logic_autolock_request_lock': (8, 0x107, 1, True),
    'logic_autolock_autolock_mode': (8, 0x108, 2, True),
    'logic_autolock_lock_running': (8, 0x109, 1, False),
    'logic_raw_acquisition_iir_z0': (8, 0x10a, 27, True),
    'logic_raw_acquisition_iir_a1': (8, 0x10e, 25, True),
    'logic_raw_acquisition_iir_a2': (8, 0x112, 25, True),
    'logic_raw_acquisition_iir_a3': (8, 0x116, 25, True),
    'logic_raw_acquisition_iir_a4': (8, 0x11a, 25, True),
    'logic_raw_acquisition_iir_a5': (8, 0x11e, 25, True),
    'logic_raw_acquisition_iir_b0': (8, 0x122, 25, True),
    'logic_raw_acquisition_iir_b1': (8, 0x126, 25, True),
    'logic_raw_acquisition_iir_b2': (8, 0x12a, 25, True),
    'logic_raw_acquisition_iir_b3': (8, 0x12e, 25, True),
    'logic_raw_acquisition_iir_b4': (8, 0x132, 25, True),
    'logic_raw_acquisition_iir_b5': (8, 0x136, 25, True),
    'logic_control_signal_clr': (8, 0x13a, 1, True),
    'logic_control_signal_max': (8, 0x13b, 25, False),
    'logic_control_signal_min': (8, 0x13f, 25, False),
    'logic_combined_error_signal_clr': (8, 0x143, 1, True),
    'logic_combined_error_signal_max': (8, 0x144, 25, False),
    'logic_combined_error_signal_min': (8, 0x148, 25, False),
    'logic_combined_error_signal_filtered_clr': (8, 0x14c, 1, True),
    'logic_combined_error_signal_filtered_max': (8, 0x14d, 25, False),
    'logic_combined_error_signal_filtered_min': (8, 0x151, 25, False),
